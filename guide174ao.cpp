...
//total move is 9 seconds in each axis.
    ...
    set_value("mount_dx1", g->mount_dx1/N);
    set_value("mount_dx2", g->mount_dx2/N);
    set_value("mount_dy1", g->mount_dy1/N);
    set_value("mount_dy2", g->mount_dy2/N);
